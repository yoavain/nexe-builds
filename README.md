...
> Current version `0.3.1`. Current remote URL: `https://github.com/yoavain/nexe-builds/releases/download/0.3.1/`
...
To use the pre-built binaries with nexe just add `--remote https://github.com/yoavain/nexe-builds/releases/download/0.3.1/`
...
NEXE_REMOTE="https://github.com/yoavain/nexe-builds/releases/download/0.3.1/"
# Do nexe build
