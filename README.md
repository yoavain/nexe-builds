...
> Current version `0.2.0`. Current remote URL: `https://github.com/yoavain/nexe-builds/releases/download/0.2.0/`
...
To use the pre-built binaries with nexe just add `--remote https://github.com/yoavain/nexe-builds/releases/download/0.2.0/`
...
NEXE_REMOTE="https://github.com/yoavain/nexe-builds/releases/download/0.2.0/"
# Do nexe build
